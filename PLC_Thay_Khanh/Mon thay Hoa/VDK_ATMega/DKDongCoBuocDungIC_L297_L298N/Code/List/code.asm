...
; 0000 0034 // Func7=In Func6=In Func5=Out Func4=In Func3=In Func2=In Func1=In Func0=In
; 0000 0035 // State7=T State6=T State5=0 State4=T State3=T State2=T State1=T State0=T
...
; 0000 0045 // Mode: Fast PWM top=ICR1
...
; 0000 004E TCCR1A=0x82;
	LDI  R30,LOW(130)
	OUT  0x2F,R30
; 0000 004F TCCR1B=0x1B;
	LDI  R30,LOW(27)
	OUT  0x2E,R30

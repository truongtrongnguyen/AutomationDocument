...
;unsigned char SoHienThi, Status;
;
;void QuetPhim(void)
; 0000 001E {
...
; 0000 001F 
; 0000 0020 
; 0000 0021        if(PINB.0 == 0 && PINB.1 == 1 && PINB.2 == 1 && PINB.3 == 1)
	RCALL SUBOPT_0x0
	BRNE _0x4
	SBIS 0x16,1
	RJMP _0x4
...
_0x5:
; 0000 0022        {
; 0000 0023              SoHienThi = 1;
	LDI  R30,LOW(1)
	RJMP _0x2A
; 0000 0024        }
; 0000 0025        else if(PINB.0 == 1 && PINB.1 == 0 && PINB.2 == 1 && PINB.3 == 1)
_0x3:
	SBIS 0x16,0
	RJMP _0x8
	RCALL SUBOPT_0x1
...
_0x9:
; 0000 0026        {
; 0000 0027              SoHienThi = 2;
	LDI  R30,LOW(2)
	RJMP _0x2A
; 0000 0028        }
; 0000 0029        else if(PINB.0 == 0 && PINB.1 == 0 && PINB.2 == 1 && PINB.3 == 1)
_0x7:
	RCALL SUBOPT_0x0
	BRNE _0xC
	RCALL SUBOPT_0x1
...
_0xD:
; 0000 002A        {
; 0000 002B              SoHienThi = 3;
	LDI  R30,LOW(3)
	RJMP _0x2A
; 0000 002C        }
; 0000 002D        else if(PINB.0 == 1 && PINB.1 == 1 && PINB.2 == 0 && PINB.3 == 1)
_0xB:
	SBIS 0x16,0
	RJMP _0x10
	SBIS 0x16,1
...
_0x11:
; 0000 002E        {
; 0000 002F              SoHienThi = 4;
	LDI  R30,LOW(4)
	RJMP _0x2A
; 0000 0030        }
; 0000 0031        else if(PINB.0 == 0 && PINB.1 == 1 && PINB.2 == 0 && PINB.3 == 1)
_0xF:
	RCALL SUBOPT_0x0
	BRNE _0x14
	SBIS 0x16,1
...
_0x15:
; 0000 0032        {
; 0000 0033              SoHienThi = 5;
	LDI  R30,LOW(5)
	RJMP _0x2A
; 0000 0034        }
; 0000 0035        else if(PINB.0 == 1 && PINB.1 == 0 && PINB.2 == 0 && PINB.3 == 1)
_0x13:
	SBIS 0x16,0
	RJMP _0x18
	RCALL SUBOPT_0x1
...
_0x19:
; 0000 0036        {
; 0000 0037              SoHienThi = 6;
	LDI  R30,LOW(6)
	RJMP _0x2A
; 0000 0038        }
; 0000 0039        else if(PINB.0 == 0 && PINB.1 == 0 && PINB.2 == 0 && PINB.3 == 1)
_0x17:
	RCALL SUBOPT_0x0
	BRNE _0x1C
	RCALL SUBOPT_0x1
...
_0x1D:
; 0000 003A        {
; 0000 003B              SoHienThi = 7;
	LDI  R30,LOW(7)
	RJMP _0x2A
; 0000 003C        }
; 0000 003D        else if(PINB.0 == 1 && PINB.1 == 1 && PINB.2 == 1 && PINB.3 == 0)
_0x1B:
	SBIS 0x16,0
	RJMP _0x20
	SBIS 0x16,1
...
_0x21:
; 0000 003E        {
; 0000 003F              SoHienThi = 8;
	LDI  R30,LOW(8)
	RJMP _0x2A
; 0000 0040        }
; 0000 0041        else if(PINB.0 == 0 && PINB.1 == 1 && PINB.2 == 1 && PINB.3 == 0)
_0x1F:
	RCALL SUBOPT_0x0
	BRNE _0x24
	SBIS 0x16,1
...
; 0000 004E // State7=1 State6=1 State5=1 State4=1 State3=1 State2=1 State1=1 State0=1
; 0000 004F PORTA=0xFF;
	LDI  R30,LOW(255)
	OUT  0x1B,R30
; 0000 0050 DDRA=0xFF;
	OUT  0x1A,R30
...
; 0000 009A UCSRB=0x00;
	OUT  0xA,R30
; 0000 009B 
; 0000 009C // Analog Comparator initialization
; 0000 009D // Analog Comparator: Off
; 0000 009E // Analog Comparator Input Capture by Timer/Counter 1: Off
; 0000 009F ACSR=0x80;
	LDI  R30,LOW(128)
	OUT  0x8,R30
; 0000 00A0 SFIOR=0x00;
	LDI  R30,LOW(0)
	OUT  0x30,R30
; 0000 00A1 
; 0000 00A2 // ADC initialization
; 0000 00A3 // ADC disabled
; 0000 00A4 ADCSRA=0x00;
	OUT  0x6,R30
; 0000 00A5 

 ...
 *  https://mischianti.org/how-to-create-a-rest-server-on-esp8266-or-esp32-cors-request-option-and-get-part-4/
 *  Nen Coppy file html/js len VS Code de chay se hien ro Error
 */
